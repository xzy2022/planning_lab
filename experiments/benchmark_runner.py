...
class BenchmarkRunner:
    ...
    def save_failure_snapshot(self, grid_map, start, goal, debugger, algo_name, density, trial_idx):
        ...
        repro_cmd = f"python experiments/run_perception_experiment.py --mode {repro_mode} --algo {algo_name} --density {density} --seed {grid_map.seed} --show"
    ...
    def _run_dynamic(self, planner, algo_name, grid_map, vehicle, stats, density, trial_idx, seed):
        ...
        if success:
            ...
            repro_cmd = f"python experiments/run_perception_experiment.py --mode perception --algo {algo_name} --density {density} --seed {seed} --show"
